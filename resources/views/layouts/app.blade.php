    ...
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container-fluid">
            ...
            <div class="navbar-nav">
                ...
                @else
                    <a class="nav-link" href="{{route('welcome')}}">@lang('lang.welcome')</a>
                    <a class="nav-link" href="{{route('etudiants.index')}}">@lang('lang.students')</a>
                    <a class="nav-link" href="{{route('blog.index')}}">@lang('lang.blog')</a>
